...
public class AsignaturaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_capitulo = findViewById(R.id.txt_capitulo);
        et_asignatura = findViewById(R.id.txt_asigantura);
        et_urlpdf = findViewById(R.id.txt_urlpdf);
        et_ssdpdf = findViewById(R.id.txt_ssdpdf);
        et_habilitar = findViewById(R.id.txt_deshabilitar);
